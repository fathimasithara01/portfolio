...
function Footer() {
  ...
  const socialLinks = [
    ...
    {
      href: "https://www.linkedin.com/in/fathimasithara1/",
      label: "LinkedIn",
      ...
      <div className="relative max-w-7xl mx-auto z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-16">
          ...
          <motion.div variants={childVariants} className="space-y-6">
            ...
            >
              ...
              <span className={`text-2xl font-black ${themeClasses.text}`}>Fathima Sithara</span>
            </motion.a>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`text-sm ${themeClasses.textMuted}`}>Kerala</span>
            </div>
          </motion.div>
          ...
          <motion.div variants={childVariants} className="space-y-4">
            ...
            <div className="space-y-4">
              <motion.a
                href="mailto:fathimasithara011@gmail.com"
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="font-medium break-all">fathimasithara011@gmail.com</p>
                </div>
              </motion.a>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="font-medium">+91 8301955058</p>
                </div>
              </motion.a>
            </div>
          </motion.div>
        ...
        <motion.div variants={childVariants} className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className={`text-sm ${themeClasses.textMuted} text-center`}>
            © {new Date().getFullYear()} Fathima Sithara. All rights reserved.
          </p>
        </motion.div>
      </div>
    </motion.footer>
