...
const skillData = {
  ...
  backend: [
    {
      ...
      about: "Golang is a statically typed, compiled language designed for building scalable, high-performance backend systems, microservices, and concurrent applications.",
      level: 90,
    ...
    },
    {
      ...
      about: "Gin is a high-performance Golang web framework for building REST APIs with routing, middleware support, and a minimalistic design.",
      level: 90,
    ...
    },
    {
      ...
      about: "Fiber is a fast Golang web framework inspired by Express.js, used for building APIs and microservices with minimal overhead.",
      level: 75,
    ...
    },
    {
    ...
    },
     {
      ...
      about: "Redis is an in-memory key-value store used for caching, real-time analytics, and messaging, enabling ultra-fast data access.",
      level: 70,
    ...
    },
    {
      ...
      about: "Kafka is a distributed event streaming platform used to build real-time data pipelines and event-driven architectures.",
      level: 65,
  ...
  about: "REST APIs (Representational State Transfer) allow communication between client and server over HTTP. They enable CRUD operations, stateless requests, and integration of microservices, providing scalable and maintainable backend architecture.",
  level: 85,
  ...
  tools: [
    ...
    { 
      ...
      logo: FaDocker,
      iconColor: 'text-blue-500',
      about: 'Docker is a platform to develop, ship, and run applications in containers, ensuring consistent environments across systems.',
      level: 75,
      gradient: 'from-blue-500 to-cyan-500',
      experience: '6+ months',
      projects: 4,
    ...
    { 
      ...
      logo: SiPostman,
      iconColor: 'text-orange-500',
      about: 'Postman is a tool for API development and testing, allowing developers to design, debug, and document APIs efficiently.',
      level: 80,
      gradient: 'from-orange-500 to-red-500',
      experience: '7+ months',
      projects: 5,
      ...
      logo: GiPadlock,
      iconColor: 'text-yellow-500',
      about: 'JWT and OAuth2 are authentication and authorization methods for securing APIs, enabling token-based access and role-based control.',
      level: 70,
      ...
      about: 'Linux is an open-source operating system widely used in backend development for servers, scripting, and deployment.',
      level: 75,
