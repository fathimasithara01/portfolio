  ...
  const projects = [
    {
      ...
      tech: [
        { name: 'Golang', icon: <SiReact /> },
        { name: 'Fiber', icon: <SiRedux /> },
        { name: 'MongoDB', icon: <SiReact /> },
        { name: 'CSS', icon: null },
      ],
      github: 'https://github.com/fathimasithara01/chat-app',
    ...
    {
      title: 'TradeVerse - Copy Trading Platform',
      image: pageImage,
      ...
      tech: [
        { name: 'Golang', icon: <SiReact /> },
        { name: 'Gin', icon: <SiReact /> },
        { name: 'Postgress', icon: <SiReact /> },
        { name: 'JavaScript', icon: <SiTailwindcss /> },
        { name: 'Framer Motion', icon: <SiFramer /> },
      ],
      github: 'https://github.com/fathimasithara01/tradeverse',
    ...
    },
    {
      ...
      github: 'https://github.com/fathimasithara01/Ecommerce-Backend',
      demo: 'https://registration-page-green-seven.vercel.app/',
      tag: 'UI/UX',
      gradient: 'from-blue-500 to-purple-600',
      accentColor: 'blue',
        ...
        >
          {projects.map((project, index) => (
            ...
            >
              {/* Glow effect */}
              <motion.div
                className={`absolute -inset-1 bg-gradient-to-r ${project.gradient} rounded-3xl opacity-0 blur-xl transition-opacity duration-500 ${hoveredIndex === index ? 'opacity-30' : ''
                  }`}
              />

              {/* Main Card - Matching About section style */}
              <div className={`relative backdrop-blur-xl ${themeClasses.card} border rounded-3xl overflow-hidden shadow-2xl transition-all duration-500 ${hoveredIndex === index ? 'transform -translate-y-2' : ''
                }`}>
                {/* Image Container */}
                <div className="relative overflow-hidden group/image">
                  ...
                  {/* Image Overlay */}
                  <motion.div
                    className={`absolute inset-0 bg-gradient-to-t ${isDarkMode ? 'from-black/80 via-black/40 to-transparent' : 'from-gray-900/80 via-gray-900/40 to-transparent'
                      }`}
                    initial={{ opacity: 0 }}
