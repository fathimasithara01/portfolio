...
const handleDownload = () => {
    Swal.fire({
      ...
      <div style="margin: 1.5rem 0;">
        ...
        <p style="color: #64748b; font-size: 1.1rem; margin-bottom: 1rem;">
          Get ready to download Fathima Sithara's professional resume
        </p>
        <div style="background: linear-gradient(135deg, #06b6d4 0%, #3b82f6 100%); padding: 0.75rem 1rem; border-radius: 0.75rem; display: inline-block;">
          <span style="color: white; font-weight: 600; font-size: 0.9rem;">📄 Fathima Sithara_c_Resume.pdf</span>
        </div>
      </div>
    `,
    ...
    `,
        ...
        `,
            ...
            link.href = "/Fathima_Sithara_Resume.pdf";
            link.download = "Fathima_Sithara_Resume.pdf";
...
function About() {
    ...
    const stats = [
        { icon: BookOpen, label: "Months Learning", value: "1 year+" },
        { icon: FaCode, label: "Projects Completed", value: "3+" },
        { icon: Coffee, label: "Cups of Coffee", value: "100+" },
        { icon: Target, label: "Skills Mastered", value: "10+" },
    ];
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <motion.div variants={itemVariant} className="space-y-8">
                            <div className="flex flex-col items-center lg:items-start">
                                ...
                                >
                                    <div
                                        className={`relative w-48 h-48 sm:w-56 sm:h-56 rounded-3xl overflow-hidden border-4 ${isDarkMode ? "border-cyan-400/30" : "border-blue-400/30"
                                            } shadow-2xl group-hover:scale-105 transition-all duration-700`}
                                    >
                                        <img
                                            src="https://strapi.dhiwise.com/uploads/golang_react_OG_Image_6f78142b9e.webp"
                                            alt="fathima sithara"
                                ...
                                <div className="text-center lg:text-left space-y-4">
                                    ...
                                    >
                                        Fathima Sithara <span className={themeClasses.accent}></span>
                                    </motion.h2>
                                    ...
                                    <div className="flex justify-center lg:justify-start gap-4 pt-4">
                                        {[
                                            { icon: FaGithub, href: "https://github.com/fathimasithara01" },
                                            {
                                                icon: FaLinkedin,
                                                href: "https://www.linkedin.com/in/fathimasithara01",
                                            },
                                        ].map(({ icon: Icon, href }) => (
                                            <a
                                                key={href}
                        ...
                        <motion.div variants={itemVariant} className="space-y-8">
                            <div className={`space-y-4 ${themeClasses.textMuted} text-lg leading-relaxed`}>
                                <p>
                                    ...
                                    Hi, I’m Fathima Sithara, a passionate Backend Developer specializing in Golang and Microservices. I have hands-on experience building scalable distributed systems, real-time applications, and secure APIs. I enjoy designing modular, high-performance architectures and implementing clean, maintainable code.
                                </p>
                                <p>
                                    <BookOpen className={`inline w-5 h-5 mr-2 ${themeClasses.accent}`} />
                                    I’ve worked on projects like real-time chat systems, SaaS copy trading platforms, and eCommerce backends, leveraging technologies such as Kafka, Redis, WebSockets, PostgreSQL, MongoDB, and JWT-based authentication.
                                </p>
                                <p>
                                    <Rocket className={`inline w-5 h-5 mr-2 ${themeClasses.accent}`} />
                                    I’m actively looking for opportunities as a Golang Backend Developer / Full Stack Developer where I can contribute to innovative, high-performance systems.                                </p>
                            </div>
