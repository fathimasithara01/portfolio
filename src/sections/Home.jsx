...
import { SiDjango, SiPostgresql, SiMongodb, SiMysql, SiGin } from "react-icons/si";
import { ChevronDown, Sparkles, Zap, Coffee, MousePointer } from 'lucide-react';
import AOS from 'aos';
import 'aos/dist/aos.css';
import fathimasitharaimg from "../assets/developer.jpg";
...
function Home() {
    ...
    const techStack = [
        { icon: FaGolang, name: "Golang", color: "from-yellow-400 to-blue-500" },
        { icon: FaReact, name: "React", color: "from-blue-400 to-cyan-500" },
        { icon: SiGin, name: "Gin", color: "from-teal-400 to-teal-500" },
        ...
        { icon: SiMysql, name: "mySQL", color: "from-blue-600 to-blue-700" },
        { icon: SiMongodb, name: "MongoDB", color: "from-green-600 to-green-700" },
    ...
    return (
        <section className={`min-h-screen py-24 px-4 relative overflow-hidden ${themeClasses.bg}`} id="home">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                {/* Gradient Orbs */}
                <motion.div
                    className={`absolute top-20 right-20 w-96 h-96 rounded-full opacity-10 blur-3xl ${isDarkMode ? 'bg-gradient-to-r from-cyan-400 to-blue-500' : 'bg-gradient-to-r from-blue-400 to-purple-500'
                        }`}
                    animate={{
                        scale: [1, 1.2, 1],
                        rotate: [0, 180, 360],
                ...
                />
                <motion.div
                    className={`absolute bottom-20 left-20 w-80 h-80 rounded-full opacity-10 blur-3xl ${isDarkMode ? 'bg-gradient-to-r from-purple-400 to-pink-500' : 'bg-gradient-to-r from-pink-400 to-orange-500'
                        }`}
                    animate={{
                        scale: [1.2, 1, 1.2],
                        rotate: [360, 180, 0],
            ...
            <motion.div
                className={`fixed pointer-events-none z-30 w-8 h-8 rounded-full mix-blend-difference ${isDarkMode ? 'bg-cyan-300/30' : 'bg-blue-500/30'
                    }`}
                style={{
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                        ...
                        >
                            <div className="relative group">
                                ...
                                <motion.div
                                    ...
                                    className={`absolute -inset-4 rounded-3xl opacity-20 blur-lg ${isDarkMode ? 'bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600' : 'bg-gradient-to-r from-blue-400 via-purple-500 to-pink-600'
                                        }`}
                                />
                                ...
                                >
                                    <img
                                        src={fathimasitharaimg}
                                        alt="fathimasithara - Golang Backend Developer"
                                        className={`w-full max-w-md sm:max-w-lg lg:max-w-xl h-96 rounded-3xl object-cover border-2 ${isDarkMode ? 'border-cyan-400/30' : 'border-blue-400/30'
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span className={themeClasses.accent}>Fathima Sithara</span>
                                    <motion.span
                            ...
                            >
                                ...
                                >
                                    <FaGolang className="text-2xl text-yellow-500" />
                                ...
                                >
                                    ...
                                    <span className={`font-semibold ${themeClasses.accent}`}>Golang</span> and{' '}
                                    <span className={`font-semibold ${themeClasses.accent}`}>React</span>.  
                                    I’m a Golang Backend Developer with experience in microservices, real-time applications, and scalable distributed systems. Passionate about building high-performance, maintainable backend solutions                                </motion.p>
                            </motion.div>
                            ...
                            >
                                {[
                                    { icon: FaGithub, href: "https://github.com/fathimasithara01", label: "GitHub" },
                                    { icon: FaLinkedin, href: "https://www.linkedin.com/in/fathimasihara01", label: "LinkedIn" },
