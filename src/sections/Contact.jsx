              ...
              <div className="space-y-6 text-sm sm:text-base">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className={`font-semibold ${themeClasses.text}`}>fathimasithara011@email.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className={`font-semibold ${themeClasses.text}`}>+91 8301955058</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className={`font-semibold ${themeClasses.text}`}>Kerala</p>
                  </div>
                </div>
              </div>
